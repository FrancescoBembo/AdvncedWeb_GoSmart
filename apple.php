      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="panel panel-default">
            ...
            <a href="apple/homepodblack.php" style="float:right;">Detail...</a>
            </div>
        ...
        <div class="col-sm-4">
          <div class="panel panel-default">
            ...
            <a href="apple/homepodwhite.php" style="float:right;">Detail...</a>
            </div>
            <button style='float:right;'  class='btn btn-default add_product' pid='$prod_id' id='$prod_id'>Add To Cart</button>
          </div><br><br>
        </div>
        <div class="col-sm-4">
          <div class="panel panel-default">
            ...
            <a href="apple/appletv.php" style="float:right;">Detail...</a>
            </div>
            <button style='float:right;' class='btn btn-default add_product' pid='$prod_id' id='$prod_id'>Add To Cart</button>
          </div>
        </div>
