...
<header>
  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="row">
      ...
      <div class="col2">
        <h1>Google ChromeCast</h1><br>
        <h2>FEATURES:</h2><br>
        <font size="4">
            <li>The Chromecast connects to your TV via the inbuilt HDMI port</li><br>
            <li>It is powered via the included AC adaptor</li><br>
            <li>It utilises your existing home WiFi network to wirelessly connect to the internet and your devices</li><br>
            <li>Chromecast is compatible with over 2,000 apps</li><br>
            <li>You can mirror your Android device or your Chrome browser directly on your TV</li><br>
            <li>It's easy to control your Chromecast using supported apps on your smartphone, tablet or laptop</li>
        </font>
        <?php
