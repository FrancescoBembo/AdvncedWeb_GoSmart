...
<header>
  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="row">
      ...
      <div class="col2">
        <h1>Google Home Hub Max</h1><br>
        <h2>FEATURES:</h2><br>
        <font size="4">
            <li>Help at a glance</li><br>
            <li>Command your day</li><br>
            <li>Simplify your smart home</li><br>
            <li>7-inch touch screen</li><br>
            <li>Answers for any moment</li><br>
            <li>Relive your memories</li>
        </font>
        <?php
