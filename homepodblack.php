...
<header>
  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="row">
            ...
            <div class="col2">
            <h1>Apple Homepod Black</h1><br>
            <h3>FEATURES:</h3><br>
            <font size="4">
                <li>High-excursion woofer with custom amplifier</li><br>
                <li>Array of seven horn-loaded tweeters, each with its own custom amplifier</li><br>
                <li>Six-microphone array for far-field Siri</li><br>
                <li>Internal low-frequency calibration microphone for automatic bass correction</li><br>
                <li>Direct and ambient audio beamforming</li><br>
                <li>Transparent studio-level dynamic processing</li><br>
            ...
            ?>
            <br>
            <button style='float:left;' type="button" class='btn btn-primary' pid='$prod_id' id='$prod_id'>Add to cart</button>
